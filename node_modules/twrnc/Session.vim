...
badd +31 ~/jaredh159/twrnc/twrnc/package.json
...
badd +2 src/types.ts
badd +1 src/hooks.ts
badd +1 src/__tests__/borders.spec.ts
...
badd +29 ~/jaredh159/twrnc/twrnc/src/__tests__/custom-utils.spec.ts
badd +1 ~/jaredh159/twrnc/twrnc/src/__tests__/screens.spec.ts
badd +1 ~/jaredh159/twrnc/twrnc/src/__tests__/arbitrary-breakpoint-prefixes.spec.ts
...
badd +1 ~/jaredh159/twrnc/twrnc/src/__tests__/inset.spec.ts
...
badd +106 ~/jaredh159/twrnc/twrnc/src/resolve/color.ts
...
badd +221 ~/jaredh159/twrnc/twrnc/src/helpers.ts
...
badd +1 ./
badd +1 ~/jaredh159/twrnc/twrnc/.npmignore
badd +389 node_modules/@types/node/console.d.ts
argglobal
%argdel
$argadd ./
edit ~/jaredh159/twrnc/twrnc/src/__tests__/custom-utils.spec.ts
...
wincmd w
argglobal
if bufexists(fnamemodify("~/jaredh159/twrnc/twrnc/src/create.ts", ":p")) | buffer ~/jaredh159/twrnc/twrnc/src/create.ts | else | edit ~/jaredh159/twrnc/twrnc/src/create.ts | endif
if &buftype ==# 'terminal'
  silent file ~/jaredh159/twrnc/twrnc/src/create.ts
endif
balt node_modules/@types/node/console.d.ts
setlocal fdm=indent
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
175
normal! zo
let s:l = 47 - ((12 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 47
